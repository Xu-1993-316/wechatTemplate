...
WxSdk.prototype.apiTicket = function (url, isOld) {
  var wxsdk = this,
    data = isOld ? location.pathname + location.search : window.location.origin + location.pathname + location.search;
...
WxSdk.prototype.configWxApis = function () {
  var wxsdk = this,
    jsApiList = this.jsApiList || this.defaultJsApiList;
...
WxSdk.prototype.configShare = function (option) {
  ...
  function setShare() {
    ...
    wx.onMenuShareAppMessage({
      ...
      success: function () {
        wxsdk.onShareSuccess && setTimeout(() => {
          wxsdk.onShareSuccess('appMessage')
        }, 300);
      },
      cancel: function () {
        wxsdk.onShareCancel && setTimeout(() => {
          wxsdk.onShareCancel('appMessage')
        }, 300);
      }
    });
    ...
    wx.onMenuShareTimeline({
      ...
      success: function () {
        wxsdk.onShareSuccess && setTimeout(() => {
          wxsdk.onShareSuccess('timeline')
        }, 300);
      },
      cancel: function () {
        wxsdk.onShareCancel && setTimeout(() => {
          wxsdk.onShareCancel('timeline')
        }, 300);
      }
    });
