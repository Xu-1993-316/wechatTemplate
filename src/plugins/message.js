...
var $message = {
  alert: function(title, content, _callback, btnTxt) {
    ...
    $button.onclick = function() {
      removeModal($modal, $overlay, $dialog, _callback)
    }
  ...
  confirm: function(title, content, _callback, leftBtnTxt, rightBtnTxt) {
    ...
    $button1.onclick = function() {
      ...
      // $dialog.style.opacity = .1;
      removeModal($modal, $overlay, $dialog, _callback, leftBtnTxt)
    }
    ...
    $button.onclick = function() {
      ...
      //     $modal.remove();
      // }, 300);
      removeModal($modal, $overlay, $dialog, _callback, rightBtnTxt)
    }
  ...
  prompt: function(title, _callback) {
    ...
    $button1.onclick = function() {
      removeModal($modal, $overlay, $dialog)
    }
    ...
    $button.onclick = function() {
      ...
      //     $modal.remove();
      // }, 300)
      removeModal($modal, $overlay, $dialog, _callback, $input.value)
    }
  ...
  toast: function(content) {
    ...
    var wrapperStyle = {
      ...
      maxWidth: '4rem',
      padding:
        '0.18666666666666668rem 0.3466666666666667rem 0.26666666666666666rem',
...
function removeModal($modal, $overlay, $dialog, _callback, val) {
  $overlay.style.opacity = 0

  setTimeout(() => {
    if (val) {
      _callback && _callback(val)
    } else {
      _callback && _callback()
    }
  ...
  $dialog.style.transform = 'translateX(-50%) scale(0.9)'
